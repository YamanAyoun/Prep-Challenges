...
const recursionPattern = (int1, int2) => {
    ...
    pattern.push(...recursionPattern(int1 - int2, int2));
...
const isPalindrome = (str) => {
    // write your code here
  const removestr = str.toLowerCase().replace(/[^a-z0-9]/g, '');
  const reversedStr = removestr.split('').reverse().join('');
  return removestr == reversedStr;
}
// -------------------------------------------------------------------------------------------------------
