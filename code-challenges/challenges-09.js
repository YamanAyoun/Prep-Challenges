...
const arrInc = (arr) => {
    let result = [];
  arr.forEach(number => {result.push(number + 10);});
  return result;
}
// -------------------------------------------------------------------------------------------------------
...
const roundDecimals = (arr) => {
    ...
    let result = [];
  arr.forEach(number => {result.push(Math.round(number));});
  return result;
}
// -------------------------------------------------------------------------------------------------------
...
const employeesBonus = (arr) => {
    // write your code here
    arr.forEach(data => {if (data.section == "Production") {
          if (data.workHours >= 8) {
            data.salary = `${(data.salary) + 100}$`;
          } else {
            data.salary = `${(data.salary) + 50}$`;
          }
        } 
      });
      return arr;
